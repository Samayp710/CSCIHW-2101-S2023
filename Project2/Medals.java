...
public class Medals {
    ...
    /*
     * Create a program that will print a table of medal winner counts with row
     * totals
     * I have provided the initial values needed, all you need to do is put the
     ...
     * 
     * After that create an ARRAYLIST that is the total of each medal awarded (IE 4
     * gold, 4 silver, 5 bronze)
    ...
    public static void main(String[] args) {
        ...
        // hint: make a temp variable for the sum and then at the end of the for loop
        // add each sum of
